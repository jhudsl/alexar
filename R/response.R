...
#' @param sessionAttributes A list of data to attach to this Alexa session.
...
#'
#' @export
alexaResponse <- function(output, card, reprompt, sessionAttributes=NULL, endSession=FALSE) {
